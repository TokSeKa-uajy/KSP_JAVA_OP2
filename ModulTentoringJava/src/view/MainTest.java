...
//        testDelete(); // delete all data 
    } // pada bagian ini silakan berkreasi sendiri untuk testing

    private static void testCreate() {
        List<Product> products = List.of(
                new Product("Nasi Goreng Ayam", "Makanan", new BigDecimal("15000"), 10),
                new Product("Mie Ayam Bakso", "Makanan", new BigDecimal("15000"), 12),
                new Product("Es teh", "Minuman", new BigDecimal("3000"), 13),
                new Product("Jus Jeruk", "Minuman", new BigDecimal("6000"),
                        14),
                new Product("Nasi Ayam sambal matah", "Makanan", new BigDecimal("25000"), 10),
                new Product("Indomie Goreng + Telur", "Makanan", new BigDecimal("12000"), 10)
        );
